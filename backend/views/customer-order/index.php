...
/* @var $searchModel common\models\CustomerOrderSearch */
...
echo Html::beginTag('div', ['class' => 'customer-order-index']);
...
$this->registerJs(
    $buttonsHelper->generateGridButtonScript(
        ...
        Url::toRoute('customer-order/update')
    )
);
...
$this->registerJs(
    $buttonsHelper->generateDeleteGridButtonScript(
        ...
        Url::toRoute('customer-order/delete'),
